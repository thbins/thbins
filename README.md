...
> 컨테이너 네이티브 환경에서 신뢰 가능한 배포와 운영 자동화를 설계·구현하는 DevOps/SRE 엔지니어입니다. Kubernetes/EKS를 중심으로 네트워크·리눅스·스토리지의 원리를 기반 삼아 문제를 해석하고, IaC와 파이프라인으로 사람이 반복하지 않아도 되는 일을 꾸준히 제거합니다.
---
