## 💡 About Me
### 원리를 바탕으로 자동화하고, 자동화를 바탕으로 확장하는 엔지니어 김태호입니다.
> 컨테이너 네이티브 환경에서 신뢰 가능한 배포와 운영 자동화를 설계·구현하는 DevOps/SRE 엔지니어입니다. Kubernetes/EKS를 중심으로 네트워크·리눅스·스토리지의 원리를 기반 삼아 문제를 해석하고, IaC와 파이프라인으로 반복 작업을 자동화합니다.
---


## 📜 Qualifications
- 리눅스마스터 2급 (2026.01.02)
- 정보처리기사 (2025.06.13)  
- AWS Soultion Architect - Associate (2025.06.08)
- ADsP (데이터 분석 준전문가) (2024.06.07)
- SQLD (SQL 개발자) (2023.07.07)
- 빅데이터분석실무 2급 (2023.09.01)  
---


## 🏫 Educations
- AWS CLOUD SCHOOL 8TH | 2024.12.26 ~ 2025.07.11 (1050H)
